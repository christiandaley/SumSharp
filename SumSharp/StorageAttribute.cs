...
/// </summary>
/// <param name="Strategy">The storage strategy to use. A non-default <see cref="StorageMode"/> 
...
public class StorageAttribute(UnionStorageStrategy Strategy = UnionStorageStrategy.Default, int UnmanagedStorageSize = 0) : Attribute
{
