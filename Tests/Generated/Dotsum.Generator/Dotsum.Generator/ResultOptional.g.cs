...
public partial struct ResultOptional<T, U> : IEquatable<ResultOptional<T, U>>
{
    ...
    public bool Equals(ResultOptional<T, U> other) => other.Index == Index && Equals(_value, other._value);
    ...
    public override bool Equals(object obj)
    {
        ...
        return Equals((ResultOptional<T, U>)obj);
    }

    public override int GetHashCode() => HashCode.Combine(Index, _value);

    public static bool operator==(ResultOptional<T, U> left, ResultOptional<T, U> right) => left.Equals(right);

    public static bool operator!=(ResultOptional<T, U> left, ResultOptional<T, U> right) => !left.Equals(right);

    public static ResultOptional<T, U> Ok(T value) => new(0, value);

    public static ResultOptional<T, U> Error(U value) => new(1, value);
    ...
    public static implicit operator ResultOptional<T, U>(T value) => Ok(value);

    public static implicit operator ResultOptional<T, U>(U value) => Error(value);
}
}
